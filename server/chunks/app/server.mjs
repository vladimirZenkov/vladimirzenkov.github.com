...
const _routes = [
  {
    ...
    alias: [],
    redirect: void 0 ,
    component: () => import('./_nuxt/index-DH43Btb2.mjs').then((m) => m.default || m)
  },
  {
    name: "members",
    path: "/members",
    ...
    alias: [],
    redirect: void 0 ,
    component: () => import('./_nuxt/members-DDkHYbOE.mjs').then((m) => m.default || m)
  },
  {
    name: "results",
    path: "/results",
    ...
    alias: [],
    redirect: void 0 ,
    component: () => import('./_nuxt/results--fGmVeEE.mjs').then((m) => m.default || m)
  }
];
...
const layouts = {
  default: () => import('./_nuxt/default-KFPdd4Jr.mjs').then((m) => m.default || m)
};
...
const _sfc_main$1 = {
  ...
  setup(__props) {
    ...
    const stack = void 0;
    const _Error404 = defineAsyncComponent(() => import('./_nuxt/error-404-R6GKnUD7.mjs').then((r) => r.default || r));
